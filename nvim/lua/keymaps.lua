...
wk.add({
  ...
  -- NORMAL and VISUAL modes
  {
    ...
    {
      "<leader>zne",
      "<cmd>ZkNew { title = vim.fn.input('Title: '), dir = 'ephemeral'}<cr>",
      desc = "New Ephemeral Note",
    },
    {
      "<leader>znr",
      "<cmd>ZkNew { title = vim.fn.input('Title: '), dir = 'reference'}<cr>",
      desc = "New Reference Note",
    },
    {
      "<leader>znj",
      "<cmd>ZkNew { title = vim.fn.input('Title: '), dir = 'journal'}<cr>",
      desc = "New Journal Note",
    },
    {
      "<leader>znw",
      "<cmd>ZkNew { title = vim.fn.input('Title: '), dir = 'work'}<cr>",
      desc = "New Work Note",
    },
    {
      "<leader>zo",
    ...
    { "<leader>g", group = "Git" },
    {
      ...
      function()
        vim.ui.input({ prompt = "Revision: " }, function(rev)
          if rev then
            vim.cmd("leftabove Gvdiffsplit " .. rev)
          end
        end)
      end,
      desc = "Git Diff",
    ...
    { "<leader>p", "<cmd>lua require'nabla'.popup()<CR>", desc = "Nabla Popup" },
    {
      ...
      desc = "Toggle Nabla Inline Rendering",
    },
...
vim.api.nvim_create_autocmd("FileType", {
  ...
  callback = function()
    vim.keymap.set(
      ...
      "<CR>",
      "<CR><C-w>p",
      { buffer = true, silent = true, desc = "Open entry and keep focus" }
    )
  end,
})
